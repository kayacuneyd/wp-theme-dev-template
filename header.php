 ...
 * @package kayatheme 
 * 
 * @since Kaya Wordpress Theme 1.0
 * 
 */
?>
                ...
                <div class="col-md-6">
                    ...
                    wp_nav_menu(
                        array(
                            ...
                            'depth'          => 3, //as we etup in our CSS
                            'container'      => 'nav', //wrapper of the menu ul 
                            'container_class' => 'main-menu', //class name of the wrapper 
                            'menu_class'     => 'top-menu d-flex flex-row navigation top-menu justify-content-end list-unstyled', //class names of the menu ul tag
